...
#ifndef _TEMPERATURE_PUBSUBTYPES_H_
#define _TEMPERATURE_PUBSUBTYPES_H_
...
#error Generated Temperature is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif
...
public:
    ...
    eProsima_user_DllExport virtual ~TemperaturePubSubType();
...
#endif // _TEMPERATURE_PUBSUBTYPES_H_